    ...
    >
      ...
      >
        <div className="flex-1">
          ...
          I am a recent graduate from the University of Michigan where I conducted qualitative and mixed-methods HCI research with Dr. Michaelanne Thomas on gendered participation, harm, and privacy in a peer to peer Facebook tech support group. 
              ...
              >
                <div className="flex flex-col space-y-1">
                  <h4 className={`font-medium dark:text-zinc-100 ${
                    post.title.includes('If we post, what will people think of us') ||
                    post.title === 'Challenges and design opportunities for online schooling in India'
                      ? 'underline'
                      : ''
                  }`}>
                    {post.title}
      ...
      <motion.section
        ...
        transition={TRANSITION_SECTION}
      >
        <h3 className="mb-5 text-lg font-medium">Related Work</h3>
     ...
     {/* {<motion.section
      ...
      <motion.section
        ...
        transition={TRANSITION_SECTION}
      >
        <h3 className="mb-5 text-lg font-medium">Teaching Assistant Experience</h3>
        <div className="flex flex-col space-y-4">
          <div>
            ...
            <p className="text-zinc-600 dark:text-zinc-400">
              2023-2024 with Dr. Nicole Ellison and Dr. Michaelanne Thomas
            </p>
          </div>
          <div>
            <h4 className="font-medium text-zinc-900 dark:text-zinc-100 mb-1">
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div>
            <h4 className="font-medium text-zinc-900 dark:text-zinc-100 mb-1">
              ...
              <br /> MS Ramaiah Institute of Technology, Bangalore, India
            </h4>
            <p className="text-zinc-600 dark:text-zinc-400">
              Coursework: Architecture design, urban planning, art theory, graphic design, introduction to sociology
            </p>
          </div>
        </div>
      </motion.section>
      ...
      */}
      ...
      >
        ...
        <p className="mb-5 text-zinc-600 dark:text-zinc-400">
          ...
          <a className="underline dark:text-zinc-300" href={`mailto:${'rakshavh@umich.edu'}`}>
            {'rakshavh@umich.edu'}
          </a>
        </p>
